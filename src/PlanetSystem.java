public class PlanetSystem {
    ...
    public PlanetSystem(){
        ...
        this.getPlanet()[2] = new Planet(75 * SCALE, 0.017, 4, new SpriteSheet("/res/planets.png").getSprite(96, 0, WIDTH, HEIGHT));
        this.getPlanet()[3] = new Planet(90 * SCALE, 0.093, 3.6, new SpriteSheet("/res/planets.png").getSprite(128, 0, WIDTH, HEIGHT));
        this.getPlanet()[4] = new Planet(120 * SCALE, 0.048, 2.5, new SpriteSheet("/res/planets.png").getSprite(0, 32, WIDTH, HEIGHT));
